...
require COLORHUB_PLUGIN_DIR. 'plugin-update-checker/plugin-update-checker.php';
$colorhub_update_checker = new PluginUpdateChecker_3_1 (
    'http://brandexponents.com/oshin-plugins/colorhub.json',
    __FILE__,
    'colorhub'
);
