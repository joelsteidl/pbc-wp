	...
	<?php if ( $enmse_lo == 1 ) { ?>
		<input type="hidden" name="enmse-embed-options" value="&amp;enmse_lo=1&amp;enmse_a=0&amp;enmse_de=<?php echo $enmse_de; ?>&amp;enmse_d=<?php echo $enmse_d; ?>&amp;enmse_sh=<?php echo $enmse_sh; ?>&amp;enmse_ex=<?php echo $enmse_ex; ?>&amp;enmse_dsm=<?php echo $enmse_dsm; ?>&amp;enmse_dam=<?php echo $enmse_dam; ?>&amp;enmse_dss=<?php echo $enmse_dss; ?>&amp;enmse_dst=<?php echo $enmse_dst; ?>&amp;enmse_dsb=<?php echo $enmse_dsb; ?>&amp;enmse_dssp=<?php echo $enmse_dssp; ?>&amp;enmse_scm=<?php echo $enmse_scm; ?>&amp;enmse_dsst=<?php echo $enmse_dsst; ?>&amp;enmse_sort=<?php echo $enmse_sort; ?>&amp;enmse_cv=<?php echo $enmse_cardview; ?>&amp;enmse_pag=<?php echo $enmse_pag; ?>&amp;enmse_apag=<?php echo $enmse_apag; ?>&amp;enmse_cv=<?php echo $enmse_cardview; ?>&amp;enmse_ddval=<?php echo $enmse_ddval; ?>&amp;enmse_hsd=<?php echo $enmse_hsd; ?>&amp;enmse_hspd=<?php echo $enmse_hspd; ?>&amp;enmse_htd=<?php echo $enmse_htd; ?>&amp;enmse_hbd=<?php echo $enmse_hbd; ?>" class="enmse-embed-options">
	<?php } else { ?>
