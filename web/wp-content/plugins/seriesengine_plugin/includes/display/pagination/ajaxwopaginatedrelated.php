...
if ( $wpdb != null ) { // Verify that user is allowed to access this page
	...
	if ( (isset($_GET['enmse_tid']) && is_numeric($_GET['enmse_tid'])) && !isset($_GET['enmse_am']) ) { /* Is a specific topic requested? */
	...
	} elseif ( (isset($_GET['enmse_bid']) && is_numeric($_GET['enmse_bid'])) && !isset($_GET['enmse_am']) ) { /* Is a specific book requested? */
		// Find all other Messages from that Book
	...
	} elseif ( (isset($_GET['enmse_spid']) && is_numeric($_GET['enmse_spid'])) || ($enmse_dssp > 0 && !isset($_GET['enmse_am']) && !isset($_GET['enmse_sid'])) ) { /* Is a specific speaker requested? */
	...
	} elseif ( (isset($_GET['enmse_am']) && is_numeric($_GET['enmse_am'])) || ($enmse_dam > 0  && !isset($_GET['enmse_spid']) && !isset($_GET['enmse_sid'])) ) { /* Are all messages requested? */
		// Find all other Messages from that Speaker
