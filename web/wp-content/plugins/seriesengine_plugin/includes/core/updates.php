...
}  elseif ( get_option('enmse_db_version') == "2.5" || get_option('enmse_db_version') == "2.5.1" || get_option('enmse_db_version') == "2.5.2" || get_option('enmse_db_version') == "2.5.5" || get_option('enmse_db_version') == "2.5.6" || get_option('enmse_db_version') == "2.5.7" || get_option('enmse_db_version') == "2.6" || get_option('enmse_db_version') == "2.6.1" || get_option('enmse_db_version') == "2.6.2"  ) { //Upgrade 2.5 to 2.7
