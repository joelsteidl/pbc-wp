...
}  elseif ( get_option('enmse_db_version') == "2.7.9.3" || get_option('enmse_db_version') == "2.7.9.4" || get_option('enmse_db_version') == "2.7.9.5" || get_option('enmse_db_version') == "2.8.0" || get_option('enmse_db_version') == "2.8.1" || get_option('enmse_db_version') == "2.8.1.1" ) { //Upgrade 2.5 to 2.7
