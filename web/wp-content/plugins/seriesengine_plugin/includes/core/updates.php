...
}  elseif ( get_option('enmse_db_version') == "2.7.9.3" || get_option('enmse_db_version') == "2.7.9.4" || get_option('enmse_db_version') == "2.7.9.5" || get_option('enmse_db_version') == "2.8.0" || get_option('enmse_db_version') == "2.8.1" || get_option('enmse_db_version') == "2.8.1.1" || get_option('enmse_db_version') == "2.8.2" || get_option('enmse_db_version') == "2.8.3" || get_option('enmse_db_version') == "2.8.3.1" ) { 
