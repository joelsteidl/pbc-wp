<?php 
			...
			foreach ($permamessages as $m) {
				...
				if ( $default_permalink_prefix == 1 && $default_permalink_speaker == 1 ) {
					if ( $enmse_speaker != "" ) {
						$cpttitle = $enmsemessaget . ": \"" . $cptgettitle . "\" from " . $enmse_speaker;
					} else {
						$cpttitle = $enmsemessaget . ": \"" . $cptgettitle . "\"";
					}
				} elseif ( $default_permalink_prefix == 1 && $default_permalink_speaker == 0 ) {
					$cpttitle = $enmsemessaget . ": \"" . $cptgettitle . "\"";
				} elseif ( $default_permalink_prefix == 0 && $default_permalink_speaker == 1 ) {
					if ( $enmse_speaker != "" ) {
						$cpttitle = "\"" . $cptgettitle . "\" from " . $enmse_speaker;
					} else {
