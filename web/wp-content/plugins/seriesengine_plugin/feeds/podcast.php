...
<channel>
	...
	<item>
	    ...
	    <itunes:author><?php echo htmlspecialchars(stripslashes($enmse_podcast->author)); ?></itunes:author>
	    <itunes:subtitle><?php if ($enmse_message->description == null) { ?><?php if ( $enmse_langswitch == 0 ) { ?><?php echo $enmse_podcastmessagefrom; ?> <?php echo $enmse_thisspeaker; ?><?php echo date_i18n($enmse_dateformat, strtotime($enmse_message->date)); ?><?php } else { ?><?php echo $enmse_thisspeaker; ?> <?php echo $enmse_podcastmessagefrom; ?><?php } ?><?php } else { echo htmlspecialchars(stripslashes(substrwords($enmse_message->description,250))); } ?></itunes:subtitle>      
		<itunes:summary><?php if ($enmse_message->description == null) { ?><?php if ( $enmse_langswitch == 0 ) { ?><?php echo $enmse_podcastmessagefrom; ?> <?php echo $enmse_thisspeaker; ?><?php echo date_i18n($enmse_dateformat, strtotime($enmse_message->date)); ?><?php } else { ?><?php echo $enmse_thisspeaker; ?> <?php echo $enmse_podcastmessagefrom; ?><?php } ?><?php } else { echo htmlspecialchars(stripslashes(substrwords($enmse_message->description,250))); } ?></itunes:summary>
