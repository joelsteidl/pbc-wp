...
<br />
<h2>Your Custom Embed Code:</h2>
<table class="form-table">
	<tr valign="top">
		<th scope="row"><p class="se-form-instructions">Copy the code to the right and insert it within a page/post on its own line in the editor.</p></th>
		<td>
