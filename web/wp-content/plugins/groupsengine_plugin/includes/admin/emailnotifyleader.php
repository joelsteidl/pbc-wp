<?php /* Groups Engine - Email Group Leader When a New Contact is Entered */
...
$enmge_lesql = $wpdb->prepare( $enmge_preparredlesql, $enmge_group_id );
...
foreach ($enmge_leaders as $l) {		
	...
	$enmge_leader_message .= "Received on " . date('F j, Y', strtotime($enmge_date)) . " at " . date('g:i A', strtotime($enmge_date)) . "</p>";
	...
	$enmge_leader_message .= "<ul><li><a href=\"" . plugins_url() . "/groupsengine_plugin/contacts/edit.php?enmge_mc=" . $enmge_mc . "&enmge_n=" . urlencode($l->leader_name) . "&enmge_qc=1\">They're joining our " . stripslashes($enmge_grouptitle) . "!</a></li>";
	$enmge_leader_message .= "<li><a href=\"" . plugins_url() . "/groupsengine_plugin/contacts/edit.php?enmge_mc=" . $enmge_mc . "&enmge_n=" . urlencode($l->leader_name) . "&enmge_qc=2\">I answered their question... No additional followup needed.</a></li>";
	$enmge_leader_message .= "<li><a href=\"" . plugins_url() . "/groupsengine_plugin/contacts/edit.php?enmge_mc=" . $enmge_mc . "&enmge_n=" . urlencode($l->leader_name) . "&enmge_qc=3\">I couldn't answer their question... More followup needed.</a></li>";
	$enmge_leader_message .= "<li><a href=\"" . plugins_url() . "/groupsengine_plugin/contacts/edit.php?enmge_mc=" . $enmge_mc . "&enmge_n=" . urlencode($l->leader_name) . "&enmge_qc=4\">I couldn't get in touch with them.</a></li></ul>";
	$enmge_leader_message .= "<p><a href=\"" . plugins_url() . "/groupsengine_plugin/contacts/edit.php?enmge_mc=" . $enmge_mc . "&enmge_n=" . urlencode($l->leader_name) . "\">Click here</a> for more options and to view existing updates.</p>";
