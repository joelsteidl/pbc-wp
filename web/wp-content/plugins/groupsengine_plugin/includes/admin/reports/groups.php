...
<?php $tableodd = 0; foreach ($enmge_groups as $g) { ?>
	<tr<?php if ( $tableodd == 1 ) { echo " class=\"odd\""; }?>>
		...
		<td><?php if ( $g->group_day == 1 ) { echo "Sun";  } ?><?php if ( $g->group_day == 2 ) { echo "Mon";  } ?><?php if ( $g->group_day == 3 ) { echo "Tue";  } ?><?php if ( $g->group_day == 4 ) { echo "Wed";  } ?><?php if ( $g->group_day == 5 ) { echo "Thu";  } ?><?php if ( $g->group_day == 6 ) { echo "Fri";  } ?><?php if ( $g->group_day == 7 ) { echo "Sat";  } ?><?php if ( $g->group_day == 8 ) { echo "Var";  } ?></td>
...
<h5 class="footer">Report generated by <strong>Groups Engine</strong> for <em><?php echo $enmge_options['ministryname']; ?></em> on <?php echo date_i18n($enmge_dateformat); ?></h5>
</body>
</html>
<?php } else {
