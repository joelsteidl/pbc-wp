...
} elseif ( get_option('enmge_db_version') == "1.13" || get_option('enmge_db_version') == "1.14" || get_option('enmge_db_version') == "1.15" || get_option('enmge_db_version') == "1.16" || get_option('enmge_db_version') == "1.17" || get_option('enmge_db_version') == "1.18" || get_option('enmge_db_version') == "1.19" || get_option('enmge_db_version') == "1.20" || get_option('enmge_db_version') == "1.21" || get_option('enmge_db_version') == "1.22" || get_option('enmge_db_version') == "1.23" || get_option('enmge_db_version') == "1.3.0" || get_option('enmge_db_version') == "1.3.0.1" || get_option('enmge_db_version') == "1.3.1" || get_option('enmge_db_version') == "1.3.2" || get_option('enmge_db_version') == "1.3.3" || get_option('enmge_db_version') == "1.3.4" ) { // 1.2.1
