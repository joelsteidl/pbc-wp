...
if ( isset($enmge_options['nogroups']) ) {
	$enmge_nogroups = $enmge_options['nogroups'];
} else {
	$enmge_nogroups = "No " . $enmge_groupptitle . " are currently available that match this search criteria. Please search again using the options above.";
}
...
?>
		<script type="text/javascript" src="<?php echo plugins_url() . "/groupsengine_plugin/js/ajaxload.js"; ?>"></script>
		...
		<div class="ge-explore-bar">
			<?php if ( $enmge_gl == 1 ) { ?><h4 class="ge-explore-back"><a href="<?php echo $enmge_sortoptions . $enmge_pageoptions . $enmge_ajaxoptions . "&enmge_o=1"; ?>" class="enmge-ajax-back">Search<span class="mobhide"> <?php echo stripslashes($enmge_groupptitle); ?></span></a></h4><?php } ?>
	    ...
	    <div class="ge-single-group">
	    	...
	    	<?php if ($enmge_sm != 0) { ?>
	    	<div id="ge-map-canvas" style=""></div>
	    	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?<?php if ( $enmge_apikey != null) { ?>key=<?php echo $enmge_apikey; ?>&<?php } ?>sensor=false&callback=initialize"></script>
		...
		<div class="ge-explore-bar">
			...
			<?php if ( $enmge_vo == 1 ) { ?><h4 class="ge-view-toggle"><?php if ( $enmge_v == 1 ) { ?><a href="<?php echo $enmge_thispage . $enmge_mapoptions; ?>" class="ge-list-toggle enmge-ajax-view" name="<?php echo $enmge_ajaxoptions; ?>"><span class="mobhide">View as </span>List</a><?php } else { ?><a href="<?php echo $enmge_thispage . $enmge_sortoptions . "&enmge_v=1"; ?>" class="ge-map-toggle enmge-ajax-view" name="<?php echo $enmge_ajaxoptions . "&enmge_v=1"; ?>"><span class="mobhide">View as </span>Map</a><?php } ?></h4><?php } ?>
		</div>
		<?php } ?>
		<?php if ( $enmge_fo == 0 ) { ?>
		...
		<form action="<?php echo $enmge_thispage; ?>" method="post" class="enmge-ajax-form">
			...
			<div class="ge-option-container" <?php if ( $enmge_xd == 1 ) { echo "style=\"display: none\""; } ?>>
			...
			<div class="ge-submit-padding">
				<input type="submit" value="Search" class="ge-filter-submit" tabindex="11" />
			</div>
		</form>
		</div>
		<?php } ?>
		<?php if ( empty($enmge_groups) ) { ?>
			<p class="nogroups"><?php echo $enmge_nogroups; ?></p>
		<?php } else { ?>
			<?php if ( $enmge_v == 1 ) { ?>
		    ...
		    <script type="text/javascript">
		    	function initialize() { // Initialize map and add options
		    		...
		    		jQuery.getScript("<?php echo plugins_url() . "/groupsengine_plugin/js/oms.min.js"; ?>")
						.done(function() {
