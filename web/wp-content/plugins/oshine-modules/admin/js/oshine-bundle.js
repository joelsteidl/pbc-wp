  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      module.exports = function (atts) {
        ...
        if (
          Immutable.OrderedMap.isOrderedMap(atts) &&
          !isEmpty(atts.get("css_id"))
        ) {
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      module.exports = function (atts) {
        ...
        if (
          ...
          visibilityClasses += atts
            .get("hide_in")
            .split(",")
            .map(function (deviceClass) {
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      module.exports = function (moduleName, attName, value, moduleOptions) {
        ...
        if ("string" === typeof value) {
          ...
          console.log(
            "value is not a string, check module options of",
            moduleName
          );
          value = "";
        }
        ...
        var Skill = React.createClass({
          ...
          render: function render() {
            var skill = this.props.module,
              ...
              cssUtilClasses =
                " " + visibilityClass + " be-pb-observer-" + skill.get("id");
            ...
            return "horizontal" === direction
              ? React.createElement(
                  "div",
                  _extends({}, generateIdentifierId(atts), {
                    className:
                      "oshine-module skill-wrap " +
                      " " +
                      cssUtilClasses +
                      " " +
                      atts.get("css_classes"),
                    style: cssObject[id],
                  }),
                  React.createElement(
                    "span",
                    {
                      className:
                        "skill_name " + gradientClass[id + " .skill_name"],
                      style: cssObject[id + " .skill_name"],
                    },
                    title
                  ),
                  React.createElement(
                    ...
                    {
                      className: "skill-bar",
                      style: cssObject[id + " .skill-bar"],
                    },
                    React.createElement("span", {
                      className: "be-skill expand alt-bg alt-bg-text-color",
                      "data-skill-value": value,
                      style: cssObject[id + " .be-skill"],
                    })
                  )
                )
              : React.createElement(
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                {
                  className: "animate-icon-module-style1-wrap clearfix",
                  style: cssObject.style[".animate-icon-module-style1-wrap"],
                  "data-gutter-width": gutter,
                },
                children.map(function (animateIcon) {
                  return React.createElement(AnimateIconStyle1, {
                    gutter: gutter,
                    module: animateIcon,
                    cssObject: cssObject,
                    moduleOptions: moduleOptions,
        ...
        var AnimateIconsStyle2 = React.createClass({
          ...
          render: function render() {
            ...
            return React.createElement(
              ...
              _extends({}, generateIdentifierId(atts), {
                className:
                  "oshine-module animate-icon-module-style2-wrap clearfix" +
                  " " +
                  cssUtilClasses +
                  " " +
                  atts.get("css_classes"),
              ...
              children.map(function (animateIcon) {
                return React.createElement(AnimateIconStyle2, {
                  module: animateIcon,
                  moduleOptions: moduleOptions,
                  cssObject: cssObject,
                });
        ...
        var AnimatedLink = React.createClass({
          ...
          render: function render() {
            ...
            return React.createElement(
              ...
              _extends({}, generateIdentifierId(atts), {
                className:
                  "oshine-animated-link oshine-module align-" +
                  alignment +
                  " " +
                  generateVisibilityClasses(atts) +
                  " " +
                  atts.get("css_classes"),
                style: cssObject["root"],
              }),
              React.createElement(
                "a",
                {
                  ...
                  className: "animated-link-" + linkStyle + " " + animate,
                  href: url,
                  style: jQuery.extend({}, lineColor, fontSize),
                ...
                linkStyle == "style4" || linkStyle == "style5"
                  ? React.createElement(
                      "div",
                      { className: "next-arrow" },
                      React.createElement("span", {
                        className: "arrow-line-one",
                        style: { backgroundColor: lineColor.color },
                      }),
                      React.createElement("span", {
                        className: "arrow-line-two",
                        style: { backgroundColor: lineColor.color },
                      }),
                      React.createElement("span", {
                        className: "arrow-line-three",
                        style: { backgroundColor: lineColor.color },
                      })
                    )
                  : null
        ...
        var Clients = React.createClass({
          ...
          render: function render() {
            ...
            if (!isEmpty(atts)) {
              ...
              slideShowSpeed = parseValue(
                clients.get("name"),
                "slide_show_speed",
                atts.get("slide_show_speed"),
                moduleOptions
              );
              ...
              if (
                "string" === typeof slideShowSpeed &&
                !isNaN(slideShowSpeed.replace(/\D+/, "")) &&
                "" != slideShowSpeed.replace(/\D+/, "")
              ) {
            ...
            return React.createElement(
              ...
              React.createElement(
                "ul",
                {
                  className: "be-owl-carousel client-carousel-module",
                  "data-slide-show": slideShow,
                  "data-slide-show-speed": slideShowSpeed,
                },
                children.map(
                  function (client) {
                    return React.createElement(Client, {
                      key: client.get("id"),
                      moduleOptions: moduleOptions,
                      module: client,
                      cssObject: this.props.cssObject,
        ...
        var ContentSlider = React.createClass({
          ...
          render: function render() {
            ...
            if (!isEmpty(atts)) {
              ...
              console.log(
                _typeof(atts.get("content_max_width")),
                atts.get("content_max_width")
              );
              contentMaxWidth = parseValue(
                moduleName,
                "content_max_width",
                atts.get("content_max_width"),
                moduleOptions
            ...
            return React.createElement(
              ...
              _extends({}, generateIdentifierId(atts), {
                className:
                  "oshine-module content-slide-wrap " +
                  " " +
                  generateVisibilityClasses(atts) +
                  " " +
                  atts.get("css_classes"),
              ...
              React.createElement(
                ...
                React.createElement(
                  "ul",
                  {
                    className: "clearfix slides content_slider_module clearfix",
                    "data-slide-show": slideShow,
                    "data-slide-show-speed": slideShowSpeed,
                    "data-slide-animation-type": "slide",
                  },
                  children.map(function (slide) {
                    return React.createElement(ContentSlide, {
                      key: slide.get("id"),
      ...
      /* WEBPACK VAR INJECTION */ (function (
        ...
        var IconCard = React.createClass({
          ...
          getWrapperClass: function getWrapperClass(atts) {
            ...
            //changed Code to reflect Icon Card in Page Builder
        ...
        var ImageSlider = React.createClass({
          ...
          render: function render() {
            ...
            return React.createElement(
              ...
              _extends({}, generateIdentifierId(atts), {
                className:
                  "be_image_slider oshine-module style1-arrow " +
                  visibilityClass +
                  " " +
                  atts.get("css_classes"),
                style: cssObject["root"],
              ...
              React.createElement(
                "div",
                {
                  className: "image_slider_module slides",
                  "data-animation": "fade",
                  "data-slide-show": slideShow,
                  "data-slide-show-speed": slideShowSpeed,
                },
        ...
        var MenuCard = React.createClass({
          ...
          render: function render() {
            var menuCard = this.props.module,
              ...
              visibilityClass = generateVisibilityClasses(atts),
              cssUtilClasses =
                " " + visibilityClass + " " + atts.get("css_classes");
            if (!isEmpty(atts)) {
              title = atts.get("title");
              if (isEmpty(title)) {
                title = null;
            ...
            return React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  "span",
                  {
                    className: "h6-font menu-card-title",
                    style: cssObject[".menu-card-title"],
                  },
                  " ",
                  title,
                  " "
                ...
                React.createElement(
                  "span",
                  {
                    className: "menu-card-ingredients special-subtitle",
                    style: cssObject[".menu-card-ingredients"],
                  },
                  " ",
                  ingredients,
                  " "
                ...
                React.createElement(
                  "span",
                  {
                    className: "menu-card-item-price",
                    style: cssObject[".menu-card-item-price"],
                  },
                  " ",
                  price,
                  " "
                ...
                star
                  ? React.createElement("i", {
                      className:
                        "icon-icon_star menu-card-item-stared alt-color",
                      style: cssObject[".menu-card-item-stared"],
                    })
                  : null
              )
            );
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */ (function (
        ...
        var Process = React.createClass({
          ...
          getDividerHeight: function getDividerHeight(
            iconSize,
            name,
            moduleOptions
          ) {
            var dividerHeight = 0,
              ...
              unit = "";
            if (
              "string" === typeof iconSize &&
              "" != iconSize.replace(/\D+/, "") &&
              !isNaN(iconSize.replace(/\D+/, ""))
            ) {
          ...
          render: function render() {
            ...
            children.forEach(
              function (processCol) {
                var dividerHeight = this.getDividerHeight(
                  processCol.getIn(["atts", "icon_size"]),
                  processCol.get("name"),
                  moduleOptions
                );
                outputArray.push(
                  React.createElement(ProcessColumn, {
                    parentId: process.get("id"),
                    dividerHeight: dividerHeight,
                    key: processCol.get("id"),
                    module: processCol,
                    moduleOptions: moduleOptions,
                    cssObject: cssObject,
            ...
            return React.createElement(
              "div",
              _extends({}, generateIdentifierId(atts), {
                className: "oshine-module process-style1 " + cssUtilClasses,
                style: cssObject["root"],
                "data-col": "1",
              }),
              outputArray
      ...
      var Services = React.createClass({
        ...
        render: function render() {
          ...
          return React.createElement(
            ...
            React.createElement("span", {
              className: "timeline",
              style: cssObject.style[".timeline"],
            })
          );
        },
      });
        ...
        var Skills = React.createClass({
          ...
          render: function render() {
            ...
            if (!isEmpty(atts)) {
              ...
              if (
                "string" === typeof height &&
                "" != height.replace(/\D+/, "") &&
                !isNaN(height.replace(/\D+/, ""))
              ) {
                height = height;
              } else {
                height = "400px";
            ...
            return React.createElement(
              ...
              _extends({}, generateIdentifierId(atts), {
                className:
                  "oshine-module skill_container be-shortcode skill-" +
                  direction +
                  " " +
                  cssUtilClasses +
                  " " +
                  atts.get("css_classes"),
                style: jQuery.extend({}, skillsStyle, cssObject["root"]),
              }),
              React.createElement(
                "div",
                { className: "skill clearfix" },
                children.map(function (skill) {
                  return React.createElement(Skill, {
                    key: skill.get("id"),
                    height: height,
                    module: skill,
                    moduleOptions: moduleOptions,
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */ (function (
        ...
        var SpecialHeadingStyle1 = React.createClass({
          ...
          getSeparatorStyle: function getSeparatorStyle(
            atts,
            specialHeading,
            moduleOptions
          ) {
            var separatorStyle = {},
              ...
              separatorWidth = parseValue(
                specialHeading.get("name"),
                "separator_width",
                atts.get("separator_width"),
                moduleOptions
              ),
              separatorThickness = parseValue(
                specialHeading.get("name"),
                "separator_thickness",
                atts.get("separator_thickness"),
                moduleOptions
              );
            ...
            if (
              "string" === typeof separatorWidth &&
              "" != separatorWidth.replace(/\D+/, "") &&
              !isNaN(separatorWidth.replace(/\D+/, ""))
            ) {
            ...
            if (
              "string" === typeof separatorThickness &&
              "" != separatorThickness.replace(/\D+/, "") &&
              !isNaN(separatorThickness.replace(/\D+/, ""))
            ) {
          ...
          getSeparatorWithIcon: function getSeparatorWithIcon(
            atts,
            specialHeading,
            moduleOptions,
            cssObject
          ) {
            var separatorStyle = this.getSeparatorStyle(
                atts,
                specialHeading,
                moduleOptions
              ),
            ...
            var sepIconColor = isEmpty(cssObject[".sep-icon"])
                ? cssObject[".sep-icon.oshine_diamond"]
                : cssObject[".sep-icon"],
            ...
            if (isEmpty(disableSeparator)) {
              if (!isEmpty(separatorIconStyle)) {
                ...
                separatorStyle.width =
                  separatorStyle.width.replace(/\D+/, "") / 2 +
                  separatorStyle.width.replace(/\d+/, "");
                return React.createElement(
                  "div",
                  { className: "sep-with-icon-wrap margin-bottom" },
                  React.createElement("span", {
                    className: "sep-with-icon",
                    style: newSeperatorStyle,
                  }),
                  React.createElement("i", {
                    className: "sep-icon font-icon " + icon,
                    style: sepIconColor,
                  }),
                  React.createElement("span", {
                    className: "sep-with-icon",
                ...
                return React.createElement(
                  ...
                  React.createElement("hr", {
                    className: "separator margin-bottom",
                    style: newSeperatorStyle,
                  })
                );
              }
          ...
          render: function render() {
            ...
            if (isEmpty(separatorPosition)) {
              if ("undefined" != typeof subTitleContent) {
                outputArray.push(
                  React.createElement("div", {
                    className: "sub-title margin-bottom " + subTitleClass,
                    dangerouslySetInnerHTML: { __html: subTitleContent },
                  })
                );
              }
              outputArray.push(
                this.getSeparatorWithIcon(
                  atts,
                  specialHeading,
                  moduleOptions,
                  cssObject
        ...
        var SpecialHeadingStyle2 = React.createClass({
          ...
          render: function render() {
            ...
            return React.createElement(
              "div",
              _extends({}, generateIdentifierId(atts), {
                className: wrapperClass + " " + cssUtilClasses,
                style: cssObject["root"],
              }),
              React.createElement(
                "div",
                {
                  className:
                    "special-heading " +
                    this.props.cssObject.class[".special-heading"],
                  style: newHeadingStyle,
                },
                React.createElement(
                  TitleTag,
                  {
                    className:
                      "special-h-tag " +
                      this.props.cssObject.class[".special-h-tag"],
                    style: newTitleColor,
                  },
                  titleContent
                )
      ...
      /* WEBPACK VAR INJECTION */ (function (
        ...
        var SpecialHeadingStyle3 = React.createClass({
          ...
          render: function render() {
            ...
            var newTopCaptionSeparatorColor =
              cssObject[
                ".special-heading-wrap.style3 .top-caption .caption .caption-inner"
              ];
            var newTitleColor = cssObject[".special-h-tag"];
            var newBottomCaptionSeparatorColor =
              cssObject[
                ".special-heading-wrap.style3 .bottom-caption .caption .caption-inner"
              ];
            ...
            return React.createElement(
              ...
              _extends({}, generateIdentifierId(atts), {
                className: wrapperClass + " " + cssUtilClasses,
                "data-animation": animate ? animationType : null,
                style: cssObject["root"],
              }),
              "string" == typeof topCaption && "" != topCaption
                ? React.createElement(
                    "div",
                    ...
                    React.createElement(
                      ...
                      React.createElement("span", {
                        ...
                        style: newTopCaptionSeparatorColor,
                      })
                    )
                  )
                : null,
              ...
              "string" == typeof bottomCaption && "" != bottomCaption
                ? React.createElement(
                    "div",
                    { className: "caption-wrap" },
                    React.createElement(
                      "h6",
                      {
                        style: newBottomCaptionStyle,
                        className: bottomCaptionClass,
                      },
                      bottomCaption,
                      React.createElement("span", {
                        className: "caption-inner",
                        style: newBottomCaptionSeparatorColor,
                      })
                    )
                  )
                : null
      ...
      /* WEBPACK VAR INJECTION */ (function (
        ...
        var SpecialHeadingStyle4 = React.createClass({
          ...
          getWrapperClass: function getWrapperClass(atts) {
            ...
            // Change Title Element reflection
          ...
          render: function render() {
            ...
            var cssObject = this.props.cssObject.style;
            var newDividerColor =
              cssObject[".special-heading-wrap .vertical-divider"];
            var newTitleColor = cssObject[".special-h-tag"];
            ...
            return React.createElement(
              ...
              [
                "bottom" === dividerStyle
                  ? null
                  : React.createElement("div", {
                      className: "vertical-divider top",
                      style: newDividerColor,
                    }),
                "undefined" != typeof captionContent && "" != captionContent
                  ? React.createElement(
                      CaptionTag,
                ...
                "top" === dividerStyle
                  ? null
                  : React.createElement("div", {
                      className: "vertical-divider bottom",
                      style: newDividerColor,
                    }),
              ]
            );
            ...
            return React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  TitleTag,
                  {
                    className: "special-h-tag",
                    style: cssObject[".special-h-tag"],
                  },
                  titleContent
                )
              ),
      ...
      /* WEBPACK VAR INJECTION */ (function (
        ...
        var SpecialHeading6 = React.createClass({
          ...
          render: function render() {
            ...
            titleHoverStyle = jQuery.extend(
              {},
              titleStyle,
              cssObject[".style6 .special-heading-inner-wrap:hover .be-title"]
            );
            ...
            return React.createElement(
              ...
              _extends({}, generateIdentifierId(atts), {
                className:
                  "oshine-module special-heading-wrap style6 " +
                  " " +
                  generateVisibilityClasses(atts) +
                  " " +
                  atts.get("css_classes"),
                style: jQuery.extend(
                  {},
                  cssObject[".special-heading-wrap.style6"],
                  cssObject["root"]
                ),
              }),
              React.createElement(
                "div",
                {
                  className:
                    ...
                    (!isEmpty(borderStyle) ? " be-border-" + borderStyle : "") +
                    (!isEmpty(expandOnHover) ? " be-expand" : ""),
                  onMouseEnter: this.hoverHandler,
                  onMouseLeave: this.hoverHandler,
                },
                React.createElement("div", {
                  className: "be-border",
                  style: cssObject[".special-heading-wrap.style6 .be-border"],
                }),
                React.createElement(
                  "h6",
                  {
                    className: "be-title",
                    style: this.state.hovered ? titleHoverStyle : titleStyle,
                  },
        ...
        var SpecialSubTitle = React.createClass({
          ...
          render: function render() {
            ...
            if (!isEmpty(atts)) {
              ...
              bottomMargin = parseValue(
                specialSubTitle.get("name"),
                "margin_bottom",
                atts.get("margin_bottom"),
                moduleOptions
              );
              alignment = atts.get("title_alignment");
              animate = atts.get("animate");
            ...
            return React.createElement(
              ...
              _extends({}, generateIdentifierId(atts), {
                ...
                style: jQuery.extend(
                  {},
                  cssObject[".special-subtitle-wrap"],
                  cssObject["root"]
                ),
              }),
              React.createElement(
                ...
                "undefined" != typeof titleContent
                  ? React.createElement(
                      "span",
                      {
                        className:
                          "special-subtitle " +
                          gradientClass[".special-subtitle"],
                        style: cssObject[".special-subtitle"],
                      },
                      " ",
                      titleContent,
                      " "
      ...
      var SvgIcon = React.createClass({
        ...
        render: function render() {
          ...
          return React.createElement("div", {
            ref: "svgelement",
            className:
              "oshine-svg-icon oshine-module " +
              lineAnimate +
              " align-" +
              alignment +
              " " +
              size,
            "data-path-animation": pathAnimationType,
            "data-svg-animation": svgAnimationType,
            "data-animation-delay": lineAnimate ? animationDelay : 1,
            "data-animation-duration": lineAnimate ? animationDuration : 2,
            style: { color: color, width: width, height: height },
            "data-svg-url": content,
            "data-target": "svg-" + this.svgId,
            dangerouslySetInnerHTML: {
              __html: "<span  id=svg-" + this.svgId + " ></span>",
            },
          });
        },
      });
        ...
        var Team = React.createClass({
          ...
          getIcon: function getIcon(atts, cssObject, gradientClass) {
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      "a",
                      {
                        href: facebook,
                        className:
                          "font-icon tatsu-icon team_icons " +
                          iconBgGradientClass,
                        target: "_blank",
                        onMouseEnter: this.hoverHandler.bind(this, "facebook"),
                        onMouseLeave: this.hoverHandler.bind(this, "empty"),
                        style:
                          this.state.iconHovered == "facebook"
                            ? iconBgHoverStyle
                            : iconBgStyle,
                      },
                      React.createElement("i", {
                        className: "icon-facebook " + iconGradientClass,
                        style:
                          this.state.iconHovered == "facebook"
                            ? iconHoverStyle
                            : iconStyle,
                    ...
                    React.createElement(
                      "a",
                      {
                        ...
                        className:
                          ...
                          iconBgGradientClass,
                        target: "_blank",
                        onMouseEnter: this.hoverHandler.bind(this, "twitter"),
                        onMouseLeave: this.hoverHandler.bind(this, "empty"),
                        style:
                          this.state.iconHovered == "twitter"
                            ? iconBgHoverStyle
                            : iconBgStyle,
                      },
                      React.createElement("i", {
                        className: "icon-twitter " + iconGradientClass,
                        style:
                          this.state.iconHovered == "twitter"
                            ? iconHoverStyle
                            : iconStyle,
                    ...
                    React.createElement(
                      "a",
                      {
                        ...
                        className:
                          ...
                          iconBgGradientClass,
                        target: "_blank",
                        onMouseEnter: this.hoverHandler.bind(this, "gplus"),
                        onMouseLeave: this.hoverHandler.bind(this, "empty"),
                        style:
                          this.state.iconHovered == "gplus"
                            ? iconBgHoverStyle
                            : iconBgStyle,
                      },
                      React.createElement("i", {
                        className: "icon-gplus " + iconGradientClass,
                        style:
                          this.state.iconHovered == "gplus"
                            ? iconHoverStyle
                            : iconStyle,
                    ...
                    React.createElement(
                      "a",
                      {
                        ...
                        className:
                          ...
                          iconBgGradientClass,
                        target: "_blank",
                        onMouseEnter: this.hoverHandler.bind(this, "linkedin"),
                        onMouseLeave: this.hoverHandler.bind(this, "empty"),
                        style:
                          this.state.iconHovered == "linkedin"
                            ? iconBgHoverStyle
                            : iconBgStyle,
                      },
                      React.createElement("i", {
                        className: "icon-linkedin " + iconGradientClass,
                        style:
                          this.state.iconHovered == "linkedin"
                            ? iconHoverStyle
                            : iconStyle,
                    ...
                    React.createElement(
                      "a",
                      {
                        ...
                        className:
                          ...
                          iconBgGradientClass,
                        target: "_blank",
                        onMouseEnter: this.hoverHandler.bind(this, "youtube"),
                        onMouseLeave: this.hoverHandler.bind(this, "empty"),
                        style:
                          this.state.iconHovered == "youtube"
                            ? iconBgHoverStyle
                            : iconBgStyle,
                      },
                      React.createElement("i", {
                        className: "icon-youtube " + iconGradientClass,
                        style:
                          this.state.iconHovered == "youtube"
                            ? iconHoverStyle
                            : iconStyle,
                    ...
                    React.createElement(
                      "a",
                      {
                        ...
                        className:
                          ...
                          iconBgGradientClass,
                        target: "_blank",
                        onMouseEnter: this.hoverHandler.bind(this, "dribble"),
                        onMouseLeave: this.hoverHandler.bind(this, "empty"),
                        style:
                          this.state.iconHovered == "dribble"
                            ? iconBgHoverStyle
                            : iconBgStyle,
                      },
                      React.createElement("i", {
                        className: "icon-dribbble " + iconGradientClass,
                        style:
                          this.state.iconHovered == "dribble"
                            ? iconHoverStyle
                            : iconStyle,
                    ...
                    React.createElement(
                      "a",
                      {
                        ...
                        className:
                          ...
                          iconBgGradientClass,
                        target: "_blank",
                        onMouseEnter: this.hoverHandler.bind(this, "vimeo"),
                        onMouseLeave: this.hoverHandler.bind(this, "empty"),
                        style:
                          this.state.iconHovered == "vimeo"
                            ? iconBgHoverStyle
                            : iconBgStyle,
                      },
                      React.createElement("i", {
                        className: "icon-vimeo " + iconGradientClass,
                        style:
                          this.state.iconHovered == "vimeo"
                            ? iconHoverStyle
                            : iconStyle,
                    ...
                    React.createElement(
                      "a",
                      {
                        ...
                        className:
                          ...
                          iconBgGradientClass,
                        target: "_blank",
                        onMouseEnter: this.hoverHandler.bind(this, "mail"),
                        onMouseLeave: this.hoverHandler.bind(this, "empty"),
                        style:
                          this.state.iconHovered == "mail"
                            ? iconBgHoverStyle
                            : iconBgStyle,
                      },
                      React.createElement("i", {
                        className: "icon-email " + iconGradientClass,
                        style:
                          this.state.iconHovered == "mail"
                            ? iconHoverStyle
                            : iconStyle,
                    ...
                    React.createElement(
                      "a",
                      {
                        ...
                        className:
                          ...
                          iconBgGradientClass,
                        target: "_blank",
                        onMouseEnter: this.hoverHandler.bind(this, "instagram"),
                        onMouseLeave: this.hoverHandler.bind(this, "empty"),
                        style:
                          this.state.iconHovered == "instagram"
                            ? iconBgHoverStyle
                            : iconBgStyle,
                      },
                      React.createElement("i", {
                        className: "icon-instagram " + iconGradientClass,
                        style:
                          this.state.iconHovered == "instagram"
                            ? iconHoverStyle
                            : iconStyle,
            ...
            return React.createElement(
              ...
              {
                className:
                  "team-social clearfix " +
                  smediaIconPosition +
                  " " +
                  teamSocialGradientclass,
                style: teamSocialStyle,
              },
              iconLi
            );
          },
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      "over" == smediaIconPosition && "style3" != titleStyle
                        ? icon
                        : null
                    )
                  ),
                  React.createElement(
                    ...
                    React.createElement(
                      "div",
                      {
                        className: "thumb-bg " + overlayGradientClass,
                        style: overlayStyle,
                      },
                      React.createElement(
                        "div",
                        ...
                        React.createElement(
                          ...
                          React.createElement(
                            "div",
                            {
                              className: "team-wrap clearfix",
                              style: teamWrapStyle,
                            },
                            React.createElement(
                              HTag,
                              {
                                className: "team-title " + titleGradientClass,
                            ...
                            React.createElement(
                              ...
                              {
                                className:
                                  "designation " + designationGradientClass,
                            ...
                            React.createElement(
                              "p",
                              {
                                className:
                                  "team-description " +
                                  descriptionGradientClass,
                                style: descriptionStyle,
                              },
                              description
                            ),
                            "below" == smediaIconPosition ||
                              "style3" == titleStyle
                              ? icon
                              : null
                          )
      ...
      /* WEBPACK VAR INJECTION */ (function (
        ...
        var Testimonials = React.createClass({
          ...
          render: function render() {
            ...
            if (!isEmpty(atts)) {
              visibilityClass = generateVisibilityClasses(atts);
              testimonialFontSize = parseValue(
                testimonials.get("name"),
                "testimonial_font_size",
                atts.get("testimonial_font_size"),
                moduleOptions
              );
              ...
              alignment = atts.get("alignment");
              if (
                "string" === typeof testimonialFontSize &&
                "" != testimonialFontSize.replace(/\D+/, "") &&
                !isNaN(testimonialFontSize.replace(/\D+/, ""))
              ) {
            ...
            return React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  {
                    className:
                      "clearfix testimonial_module slides " +
                      alignment +
                      "-content",
                    "data-slide-show": !isEmpty(slideShow) ? "1" : "0",
                    "data-slide-show-speed": !isEmpty(slideShowSpeed)
                      ? slideShowSpeed
                      : null,
                    "data-slide-animation-type": !isEmpty(slideAnimationType)
                      ? slideAnimationType
                      : null,
                    "data-pagination": !isEmpty(pagination) ? "1" : "0",
                  },
          ...
          render: function render() {
            ...
            if (!isEmpty(atts)) {
              ...
              return React.createElement(
                      ...
                      title
                        ? React.createElement(
                            TitleFont,
                            {
                              ...
                              style: { color: newIconStyle.color },
                            },
                            " ",
                            title
                          )
                ...
                !isEmpty(bgOverlay) && !isEmpty(bgImage)
                  ? React.createElement("div", {
      ...
      var AnimateIconStyle2 = React.createClass({
        ...
        render: function render() {
          ...
          if (!isEmpty(atts)) {
            ...
            if (this.state.isMouseIn) {
              bgColor =
                cssObject["." + key + ".animate-icon-module-style2:hover"];
              newIconStyle =
                cssObject[
                  "." +
                    key +
                    ".animate-icon-module-style2:hover .animate-icon-icon"
                ];
              newIconStyle.fontSize =
                cssObject["." + key + " .animate-icon-icon"].fontSize;
              iconClass = this.props.cssObject.class[
                "." +
                  key +
                  ".animate-icon-module-style2:hover .animate-icon-icon"
              ];
            ...
            return React.createElement(
              "div",
              {
                onMouseEnter: this.hoverHandler.bind(this),
                onMouseLeave: this.hoverHandler.bind(this),
                className: "animate-icon-module-style2",
                style: bgColor,
              },
              React.createElement(
                "div",
                ...
                React.createElement(
                  ...
                  {
                    className:
                      "animate-icon-module-style2-normal-content clearfix",
                  },
                  React.createElement("i", {
                    className:
                      iconClass + " animate-icon-icon font-icon " + icon,
                    style: newIconStyle,
                  }),
                  title
                    ? React.createElement(
                ...
                React.createElement("div", {
                  className:
                    "animate-icon-module-style2-hover-content clearfix",
                  dangerouslySetInnerHTML: { __html: content },
                })
              )
            );
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */ (function (
        ...
        var Client = React.createClass({
          ...
          getImageGreyScale: function getImageGreyScale(
            defaultImageStyle,
            hoverImageStyle
          ) {
            var imageGradient = "";
          ...
          render: function render() {
            var client = this.props.module,
              ...
              hoverImageStyle,
              cssUtilClasses =
                " " + visibilityClass + " be-pb-observer-" + client.get("id");
            if (!isEmpty(atts)) {
              image = atts.get("image");
              link = atts.get("link");
              ...
              imageGradient = this.getImageGreyScale(
                defaultImageStyle,
                hoverImageStyle
              );
            }
            if ("" != image) {
              return React.createElement(
                ...
                _extends({}, generateIdentifierId(atts), {
                  className:
                    "carousel-item client-carousel-item " +
                    imageGradient +
                    " " +
                    cssUtilClasses +
                    " " +
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var ImageSlide = React.createClass({
        ...
        parseUrl: function parseUrl(url) {
          ...
          if (
            -1 < hostName.indexOf("youtube") ||
            -1 < hostName.indexOf("youtu.be")
          ) {
            return "youtube";
          ...
          if (!isEmpty(atts)) {
            ...
            if ("undefined" != typeof video && "" != video) {
              if ("youtube" === this.parseUrl(video)) {
                ...
                output = React.createElement("iframe", {
                  width: "940",
                  height: "450",
          ...
          render: function render() {
            var processColumn = this.props.module,
              ...
              cssUtilClasses =
                " " + visibilityClass + " " + atts.get("css_classes"),
              gradientClass = this.props.gradientClass,
              sep_style = jQuery.extend({}, cssObject[".process-sep"], {
                top: top,
              });
            ...
            return React.createElement(
              "div",
              _extends({}, generateIdentifierId(atts), {
                className: "process-col align-center " + cssUtilClasses,
                style: cssObject[id],
              }),
              React.createElement("i", {
                className:
                  ...
                  icon +
                  " " +
                  gradientClass[id + ".process-col .font-icon"],
                style: cssObject[id + ".process-col .font-icon"],
              }),
              React.createElement("div", {
                dangerouslySetInnerHTML: { __html: content },
      ...
      var Service = React.createClass({
        ...
        render: function render() {
          ...
          var cssObject = this.props.cssObject.style,
            ...
            iconHoverStyle =
              cssObject[id + " .service-wrap:hover .service-icon"],
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement("i", {
                className: iconClass,
                style: this.state.hovered ? iconHoverStyle : iconStyle,
              }),
              React.createElement("div", {
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var TabPane = React.createClass({
        ...
        render: function render() {
          ...
          return React.createElement("div", {
            id: "fragment-" + tabsCount + "-" + id,
            dangerouslySetInnerHTML: { __html: content },
            className: "clearfix be-tab-content",
          });
        },
      });
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var Testimonial = React.createClass({
        ...
        getAuthor: function getAuthor(atts, authorGradientClass, authorStyle) {
          ...
          if ("undefined" != typeof author) {
            return React.createElement(
              "h6",
              {
                className: "testimonial-author " + authorGradientClass,
                style: authorStyle,
              },
              author
            );
        ...
        getAuthorRole: function getAuthorRole(
          atts,
          authorRoleGradientClass,
          authorRoleStyle
        ) {
          ...
          if ("undefined" != typeof authorRole) {
            ...
            return React.createElement(
              "div",
              {
                className: authorRoleClass + " " + authorRoleGradientClass,
                style: authorRoleStyle,
              },
              authorRole
            );
          } else {
        ...
        render: function render() {
          ...
          var gradientClass = this.props.cssObject.class,
            ...
            keyClass = " " + key,
            authorGradientClass =
              gradientClass["." + key + " .testimonial-author"],
            authorRoleGradientClass =
              gradientClass["." + key + " .testimonial-author-role"],
            iconGradientClass = gradientClass["." + key + " .icon-quote"],
            authorStyle = cssObject["." + key + " .testimonial-author"],
            authorRoleStyle =
              cssObject["." + key + " .testimonial-author-role"],
          ...
          return React.createElement(
            ...
            {
              className:
                "testimonial_slide slide clearfix be-testimonial-" +
                testimonial.get("id"),
            },
            React.createElement(
              "div",
              ...
              React.createElement("i", {
                className: "font-icon icon-quote " + iconGradientClass,
                style: iconStyle,
              }),
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  [
                    this.getAuthor(atts, authorGradientClass, authorStyle),
                    this.getAuthorRole(
                      atts,
                      authorRoleGradientClass,
                      authorRoleStyle
        ...
        render: function render() {
          ...
          return React.createElement(
            "h3",
            {
              ...
              style: jQuery.extend({}, toggleStyle, newToggleStyle),
            },
            title
          );
        },
