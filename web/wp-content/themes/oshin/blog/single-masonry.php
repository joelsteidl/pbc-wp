    ...
    if ( $the_query->have_posts() ) :
        while ( $the_query->have_posts() ) : $the_query->the_post();
            if ( has_post_thumbnail( get_the_ID() ) ) :
                ...
                $attachment_thumb_url = ( empty( $attachment_thumb ) || ! is_array( $attachment_thumb ) ) ? '' : $attachment_thumb[0];
                $attachment_full_url = ( empty( $attachment_full ) || ! is_array( $attachment_full ) ) ? '' : $attachment_full[0];
